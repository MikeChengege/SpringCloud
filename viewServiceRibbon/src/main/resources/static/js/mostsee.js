    ...
    $.ajax({
        ...
        success:function (data) {
            ...
            $.each(data,function (i,item) {
                var viname= "\""+item.video_title+"\"";
                var now = getNowTime();
                var hadtime= GetDateDiff(item.video_time,now,"hour");
                var html="<div class=\"thumeMostsee\" style='cursor:pointer' onclick='intoPlayPage("+item.id+","+viname+")'><div class=\"pic\">";
                html+="<img src="+item.video_pic+" style=\" width: 250px; height: 140px;\"/></div><div class=\"mostseeTxt\">"
                html+="<span class=\"txt1\" style=\"font-weight:bold\">"+item.video_title+"</span><br/>"
