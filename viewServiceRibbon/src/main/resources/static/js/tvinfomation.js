...
$(function () {
    ...
    $.ajax({
        ...
        success:function (data) {
            ...
            $("#rightIntroduction").html(data.video_descript)
    ...
    $.ajax({
        ...
        async: false,
        success:function (data) {
            if(data.msg!="error"&&data.msg!=null){
                ...
                $.each(data.msg,function(i,item) {
                    ...
                    var html = "<a href='#'> <span onclick='changeSerie(\""+item.video_address+"\",\""+item.video_depict+"\")' class=\"label label-success\" style=\"margin: 10px 6px;font-size: 15px;\">"+i+"</span></a>"
                    if(i==6||i==12||i==18||i==24){
                        html+="<br><br><br>"
                    }
                    $("#rightBottom").append(html);
                })
            }else{
...
function changeSerie(videoadd, videodis) {
        $("#playtop").load(location.href+" #playtop",function () {
            $("#videoaddress").attr("src",videoadd);
            $("#descript").html(videodis)
        });
}
